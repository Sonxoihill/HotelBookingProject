...
export const AddStaffModal = ({ isOpen, onClose, onAddStaff }) => {
  ...
  const handleSubmit = (e) => {
    ...
    onAddStaff({
      ...formData,
      email: formData.email || `${formData.name.toLowerCase().replace(/\s+/g, '.')}@letoile-resort.vn`,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mt-3.5">
              <div>
                <label className="block text-xs font-semibold text-stone-700 mb-1.5 flex items-center gap-1.5">
                  ...
                  <span>Email nội bộ (@letoile-resort.vn)</span>
                </label>
                <input
                  type="email"
                  placeholder="chau.hoang@letoile-resort.vn"
